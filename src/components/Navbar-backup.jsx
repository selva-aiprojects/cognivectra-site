        ...
        <div className="navInner container">
          ...
          <button
            ...
            style={{
              ...
              width: '44px',
              height: '44px',
              background: mobileMenuOpen ? 'rgba(99, 102, 241, 0.2)' : 'rgba(99, 102, 241, 0.1)',
          ...
          >
            <span style={{
              ...
              width: '100%',
              height: '3px',
              background: mobileMenuOpen ? 'var(--accent-secondary)' : 'var(--accent-primary)',
              borderRadius: '2px',
            ...
            <span style={{
              ...
              transform: mobileMenuOpen ? 'translateY(0) scaleX(0)' : 'translateY(0) scaleX(1)'
            }}></span>
            <span style={{
              display: 'block',
              width: '100%',
