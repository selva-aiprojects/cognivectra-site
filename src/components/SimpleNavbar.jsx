        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 20px' }}>
          ...
          >
            <span style={{
              ...
              transform: mobileMenuOpen ? 'rotate(45deg) translate(6px, 6px)' : 'rotate(0) translate(0, 0)'
            }}></span>
            <span style={{
              display: 'block',
              width: '100%',
            ...
            <span style={{
              ...
              background: 'var(--accent-primary)',
              transition: 'all 0.3s ease',
              transform: mobileMenuOpen ? 'rotate(-45deg) translate(-7px, -7px)' : 'rotate(0) translate(0, 0)'
            }}></span>
          </button>
        </div>
      </header>
